...
Workbook Basic - an accounting program that does not piss anyone off when using it. And the author of his including. Platform - Java, SQLite, Eclipse. System requirements - C:\openjdk\jdk-26.0.1.
...
Жүйе талаптары - C:\openjdk\jdk-26.0.1.
Орнату немесе жаңарту - wb.zip.
Қолдау - kursakov.s@gmail.com

Workbook Basic - учетная программа, которая никого не выбешивает при ее использовании. И автора своего в том числе. Платформа – Java, SQLite, Eclipse. Системные требования - C:\openjdk\jdk-26.0.1.
